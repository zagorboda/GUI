...
class Determinant:
    ...
    def __init__(self, main):
        ...
        btn_start = Button(root, text="Start", command=lambda: self.check(entry_m, entry_n, btn_start, label_entry_n,
                                                                     label_entry_m))
        btn_start.grid(row=3, column=0)

    def check(self, entry_m, entry_n, btn_start, label_entry_n, label_entry_m):
